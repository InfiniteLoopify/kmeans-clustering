...
<!-- TODO: REPLACE ALL `kmeans-clustering`, `Kmeans Clustering`, `Classify documents using K-Means Clustering`. FILL "about the project" and uncomment hidden sections if needed -->
<a name="readme-top"></a>
...
<br />
<div align="center">
  <!-- <a href="https://github.com/InfiniteLoopify/kmeans-clustering">
    <img src="images/logo.png" alt="Logo" width="80" height="80">
  </a> -->
<h3 align="center">Kmeans Clustering</h3>

  <p align="center">
    Classify documents using K-Means Clustering
    <br />
    <a href="https://github.com/InfiniteLoopify/kmeans-clustering"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <!-- <a href="https://github.com/InfiniteLoopify/kmeans-clustering">View Demo</a>
    · -->
    <a href="https://github.com/InfiniteLoopify/kmeans-clustering/issues/new?labels=bug&template=bug-report---.md">Report Bug</a>
    ·
    <a href="https://github.com/InfiniteLoopify/kmeans-clustering/issues/new?labels=enhancement&template=feature-request---.md">Request Feature</a>
  </p>
</div>
...
Classify documents using K-Means Clustering. Use BBC Sports data to classify into 5 classes (athletics, cricket, football, rugby and tennis).

![Screenshot](images/screenshot.png)
*classify documents correctly with 97.72% accuracy*
...
2. Clone the repository:
    ```bash
    git clone https://github.com/InfiniteLoopify/kmeans-clustering.git
    ```
...
See the [open issues](https://github.com/InfiniteLoopify/kmeans-clustering/issues) for a full list of proposed features (and known issues).
...
Project Link: [https://github.com/InfiniteLoopify/kmeans-clustering](https://github.com/InfiniteLoopify/kmeans-clustering)
...
[contributors-shield]: https://img.shields.io/github/contributors/InfiniteLoopify/kmeans-clustering.svg?style=for-the-badge
[contributors-url]: https://github.com/InfiniteLoopify/kmeans-clustering/graphs/contributors
[forks-shield]: https://img.shields.io/github/forks/InfiniteLoopify/kmeans-clustering.svg?style=for-the-badge
[forks-url]: https://github.com/InfiniteLoopify/kmeans-clustering/network/members
[stars-shield]: https://img.shields.io/github/stars/InfiniteLoopify/kmeans-clustering.svg?style=for-the-badge
[stars-url]: https://github.com/InfiniteLoopify/kmeans-clustering/stargazers
[issues-shield]: https://img.shields.io/github/issues/InfiniteLoopify/kmeans-clustering.svg?style=for-the-badge
[issues-url]: https://github.com/InfiniteLoopify/kmeans-clustering/issues
[license-shield]: https://img.shields.io/github/license/InfiniteLoopify/kmeans-clustering.svg?style=for-the-badge
[license-url]: https://github.com/InfiniteLoopify/kmeans-clustering/blob/master/LICENSE
